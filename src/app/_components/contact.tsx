...
const platformIcons: Record<string, { icon: React.ReactNode }> = {
  ...
  discord: {
    icon: <IconBrandDiscordFilled className="size-4" aria-hidden="true" />,  // ✅ Added
  },
};
        ...
        <div className="relative p-0 border-0 lg:p-10 lg:border">
          ...
          <div className="relative z-10 space-y-8">
            <div className="space-y-4 max-w-2xl">
              ...
              <TypographyLead>
                If you're building intelligent systems, data-driven
                applications, or scalable cloud solutions and need an engineer
                focused on{" "}
                <TypographyMark>
              ...
              <TypographyMuted>
                Open to full-time roles, internships, and collaborations in AI,
                cloud computing, and intelligent automation systems.
              </TypographyMuted>
            </div>
